...
SECRET_KEY = 'django-insecure-+0@%#&u^9(fgx%@2^b!=k0g9=_4#a$8k6#h&x#$&k1566-mja&'
...
# Configuración de Caché Compartida para Procesos Distribuidos
CACHES = {
    'default': {
        'BACKEND': 'django.core.cache.backends.db.DatabaseCache',
        'LOCATION': 'tabla_cache_dashboard',
    }
}